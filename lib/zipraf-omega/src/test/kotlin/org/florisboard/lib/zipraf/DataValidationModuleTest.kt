...
class DataValidationModuleTest {
    ...
    fun `test range validation outside bounds`() {
        ...
        assertEquals(ValidationStatus.ERROR.name, error?.severity)
    }
    ...
    fun `test logic validation all conditions pass`() {
        ...
        assertEquals(ValidationStatus.VALID.name, result.result)
    ...
    fun `test logic validation some conditions fail`() {
        ...
        assertEquals(ValidationStatus.INVALID.name, result.result)
